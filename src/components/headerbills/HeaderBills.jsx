    ...
    <div className="w-[70%] ml-auto font-PrincipalFont">
      <div className="flex justify-between items-center py-4 px-8 bg-white shadow">
        ...
        <div>
          ...
          <button className="text-primary-palet-900 bg-primary-palet-200 hover:bg-primary-palet-100 hover:text-primary-palet-600 border border-primary-palet-600 px-3 py-2 rounded-2xl mr-2">
            Delete All
          </button>
        </div>
      </div>
