  ...
  return (
    <nav className="flex items-center justify-between p-4 bg-white shadow-md font-PrincipalFont">
      ...
      <div className="flex items-center space-x-6">
        ...
        {/* <a href="#" className="text-gray-700 hover:text-gray-900">        <Link to="/">About</Link></a> */}
        {/* <a href="#" className="text-gray-700 hover:text-gray-900">        <Link to="/">Contact</Link></a> */}
        <button className="text-gray-700 hover:text-gray-900"><Link to="/cart">
