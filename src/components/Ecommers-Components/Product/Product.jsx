...
export const Product = () => {
    ...
    const getData = async () => {
        const rs = await fetch('https://fakestoreapi.com/products/1')
        ...
        <div className=' w-full h-screen grid place-content-center'>
            ...
            <div className=' font-PrincipalFont w-10/12 h-[800px] m-auto  p-8 flex  flex-row max-h-[650px] place-content-around'>
                ...
                <figure className='w-full grid place-content-center'>   
                    <img src={data.image} className=' max-w-[400px] h-full object-cover'></img>
                    </figure>
                </div>
                <div className='w-1/2 px-10 py-20'>
                    ...
                    <ul className='flex flex-row gap-2'>
                        {products.map(product =><ProductRecommendations product={product}/>)}
