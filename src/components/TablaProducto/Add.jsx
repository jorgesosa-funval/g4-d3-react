...
export const Add = ({ handleCancel, agregarProducto, productos }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // const newProduct = { ...nuevoProducto, id: Math.random() };
    ...
    const handleCancelClick = () => {
        handleCancel(); // Assuming this function handles canceling the add operation
    };
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-primary-palet-500 bg-opacity-50">
            <div className="bg-primary-palet-50 p-6 rounded-lg shadow-xl">
                ...
                <form onSubmit={handleSubmit} id="Producto" className="flex flex-col w-[90%] mx-auto">
                    ...
                    <input
                        ...
                        required
                        className="border border-primary-palet-400 px-3 py-2 rounded-lg mb-4"
                    />
                    ...
                    <div className="flex justify-between">
                        <button
                            type="submit"
                            className="bg-primary-palet-500 text-white px-4 py-2 rounded-lg hover:bg-primary-palet-800"
                        >
                            Agregar Producto
                        </button>
                        <button
                            type="button"
                            className="bg-gray-300 text-primary-palet-950 px-4 py-2 rounded-lg hover:bg-gray-400"
