...
export const Navbar = () => {
  return (
    <nav className='w-64 h-screen bg-primary-palet-900 bg-opacity-90 border border-primary-palet-800 rounded-r-2xl flex flex-col font-PrincipalFont shadow-md'>
